                ...
                <form  enctype="multipart/form-data" action="{{route('Products.store')}}" method="POST">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{old('price')}}" class=" @error('price') is-invalid @enderror  
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" value="{{old('description')}}" name="description" cols="30" rows="4"></textarea>
                        </div>
                        <div class="mb-3">
